...
public class CardLayout2 extends JFrame implements ActionListener{
	...
	public CardLayout2() {
		...
		panel_2.setLayout(new CardLayout());		// CardLayout() : 카드가 쌓이게 함
	...
	public void actionPerformed(ActionEvent e) {
		...
		JPanel p=(JPanel)getContentPane().getComponent(1);	// panel2를 불러내기 위해 1을 넣음
		CardLayout card=(CardLayout) p.getLayout();		
		
		if(btn==mainBtn1) {			//버튼을 눌렀을 때 원하는 패널이 뜨도록			
			card.show(p, "1");		//show() : 내가 원하는 걸 뽑고 싶은걸 뽑는다
