...
class MyPanel extends JPanel {
	...
	public MyPanel() {
		...
		s = new Arc2D.Float(410, 10, 80, 80, 0, 90, Arc2D.CHORD);
		shapeArray.add(s);
	...
	protected void paintComponent(Graphics g) {
		...
		g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);	// KEY_ANTIALIASING : 계단 현상을 막기 위함
		g2.setStroke(new BasicStroke(3));	// 두께 설정
