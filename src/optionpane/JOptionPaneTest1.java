...
//			JOptionPane.showConfirmDialog(getParent(), "대화상자 만들기");
			...
			JOptionPane.showMessageDialog(this, "정말 삭제할꺼?", "삭제", JOptionPane.PLAIN_MESSAGE, null);
...
//			JOptionPane.showInputDialog(this, "입력하세요..!");
			...
			JOptionPane.showOptionDialog(this, "스테이크를 어떻게 요리할래?", "주문", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, option, option[0]);
		}
